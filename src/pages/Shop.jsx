   ...
   useEffect(()=>{
    ...
    return(
        <div className="flex flex-col justify-center items-center gap-8">
            <h1>shop page</h1>
            <input type="text" value={searchValue} onChange={(e)=>setSearchValue(e.target.value)}  placeholder="Փնտրել ապրանք..." className="pl-[10px] placeholder:text-white bg-slate-400  outline-none border-none w-[300px] h-8 rounded-2xl" />
